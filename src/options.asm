...
DEF FILE_2C = $2C
DEF FILE_64 = $64
DEF EASTER_EGG_FILENAME_1 equs "suno esun tenpo alasa" ; Zelda
DEF EASTER_EGG_SONG_1 equ $60 ; MUSIC_ZELDA_NICKNAME_EASTER_EGG
DEF EASTER_EGG_FILENAME_2 EQUS "ken.ken." ; Totakeke
DEF EASTER_EGG_SONG_2 EQU $3C ; MUSIC_FILE_SELECT_TOTAKA
DEF THIEF_NAME equs "lawa alasa noka pan:"
DEF DEBUG_SAVE_FILE_NAME equs "o pali:pona:"
DEF __SPLIT_KEY_CAVERN_MAP__ = FALSE
DEF __DIACRITICS_SUPPORT__ = TRUE
IF (VERSION > 0)
DEF __PATCH_0__ = TRUE
