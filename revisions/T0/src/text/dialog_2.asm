...
Dialog0A7:: ;🅿️; Narrator
    ...
    toki "kin la, ilo lupa li lon poka sina la, ilo nasin li mu."
    toki_li_pini
    ;db "You've got the  "
    ;db "Compass!  Now,  "
    ;db "you can see     "
...
Dialog0B1:: ;🆖; Slime Eyes (D3 Nightmare)
    ...
    toki "mu ko   mu ko"
    toki "mu ko   mu ko"
    toki "mi lon seme? mu musi"
    toki "mu musi   mu musi"
    toki_li_pini
...
Dialog0C0:: ;🅿️; Owl
    ...
    toki "nasin pi ma ni li nasa tawa ma ante."
    toki "sina ken ala weka tan ma telo ni."
    toki "sewi kala kon li lape la, nasin li lon ala."

    toki "...open la..."
    toki "ma kasi ni li jo e ilo open pi lupa tomo."

    toki "sina tawa ala tawa lupa pi pipi linja?"
    toki "<down> ona li lon ni."

    toki "o kama jo e ilo lupa..."
    toki "o tawa lupa ma pi pipi linja..."

    toki "kala kon li lukin e sina..."
    toki "mu sona"
    toki_li_pini
    ...
    ;db "コホリントじまを、おさめるカミ　" "As long as the god who governs Koholint Island, "Wind Fish" sleeps"
    ;db "「かぜのさかな」がねむるかぎり　" /Gtranslate
    ;db "そとへのみちは、ひらかれぬ。　　" the road outside isn't open.

    ;db "．．ところで、むらのミナミの　　" ; todo: translate this
    ;db "「テ－ルのほらあな」は、みたか？"
    ;db "このもりにある　カギをもって　　"
    ;db "「テ－ルのほらあな」にいくがよい"
    ;db "「かぜのさかな」は、みておるぞ　"
...
Dialog0C1:: ;🅿️; Owl
    ...
    toki "sewi kala kon li wile e ni."
...
Dialog0C3:: ;🅿️; Owl
    ...
    toki "li lon ma ko [pan o noka kala a]."
    toki "o weka ala e sona ni."
    toki "         mu sona  mu sona"
    toki_li_pini
    ;db "Hoot!  That is a"
    ;db "fearsome looking"
...
Dialog0C5:: ;🆖; Owl
    ...
    toki "o kalama ona lon sike sewi pi kala kon."
    toki "sina ni la, sina ken weka tan ma ni."
    toki ""
    toki "o tawa ma ko [jelo anpa noka anpa]."
    toki "monsuta ike li pana e sona.  mu sona  mu sona"
    toki_li_pini
    ;db "Hoot!  How many "
    ;db "Instruments     "
    ;db "have you gotten "
...
Dialog0D9:: ;🅿️; Owl
    ...
    toki "mi awen lon ma ni. sina kama la mi toki tawa sina."
    toki "    mu sona          "
    toki "          mu sona    "
    toki_li_pini

    ; “If you want to leave the island, you must petition the Wind Fish. But first, you will need to wake him.”
    ; https://web.archive.org/web/20220117051243/https://www.glitterberri.com/links-awakening/prologue/
...
Dialog0E9:: ;🆖; Narrator
    ...
    toki "ona li pona e sina, anu seme..."
    toki_li_pini
    ;db "At last!  You've"
    ;db "got the final   "
    ;db "Golden Leaf!    "
...
Dialog0EC:: ;🅿️; Narrator
    ...
    toki "ike li pakala e sina la kili li lili e pakala."
    toki_li_pini
    ;toki "sina kama pakala la pakala li kama lili."
    ;toki "akesi li pakala e sina la pakala li kama lili."
    ;db "You've got a    "
    ;db "Guardian Acorn! "
    ;db "It will reduce  "
    ;db "the damage you  "
...
Dialog0FC:: ;🅿️; Narrator
    ...
    toki ""
    toki "seme? a sina sona anu seme?"
    toki "pona."
    toki_li_pini
