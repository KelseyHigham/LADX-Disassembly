...
Dialog10B:: ;🌞; Photographer ; plays at Toronbo Shores, and probably after every event?
...
Dialog10C:: ;🌞; Photographer
    ...
    ;db "picture?        "
    ;db "    YES  NO<ask>"
    ;写真スキスキ写真屋さん!  photos sukisuki photo shop san!
    ;写真 撮らせて!  let me take your photo!
    ;とって  ヤダ! take / no way!
    ;db "しゃしんスキスキしゃしんやさん！"
    ;db "しゃしん　とらせて！　　　　　　"
    ;db "　　　　とって　　ヤダ！<ask>"
...
Dialog10F:: ;🌞; Photographer
    toki "mi pana e nimi ni tawa sitelen ni: jan suli li lon."
    toki "o mu a!"
    toki_li_pini
    ;db "I'll call this  "
    ;db "'Here Stands A  "
...
Dialog119:: ;P1;🌞; Kid
    ...
    ;db "je suis un môme!"
    ;db "@"
    ;db "セ－ブごのさいスタ－トは、さいご" //check this
    ;db "にくぐった、でいりぐちらしいけど"
    ;db "でも、おいらこどもだから、なんの"
    ;db "ことやら、さっぱりわかんないや。"
    ;db "@"
...
Dialog11B:: ;P1;🌞; Kid
    ...
    toki "sijelo sina li pakala la, o tawa jan sewi!"
    toki "taso mi lili la mi sona ala."
    toki_li_pini

    ; I hear that when you're running out of hearts, you'd better go find a big fairy... //Switch version
...
Dialog11C:: ;🌞; Kid
    toki "a! jan suli o!"
    toki "sina pilin seme tan jan kalama [mu a loje ijo nena]?"
    toki "a! taso... mi lili la, ken la, mi sona ala."
    toki_li_pini
    ;db "Hey, dude! What "
    ;db "do you think of "
    ;db "Marin?  Uhh...  "
...
Dialog11E:: ;🌞; Kid
    toki "sike mama pi nena sewi [wawa ale ni suli insa]."
    toki "jan li toki e ni: kala kon li lape lon ona."
    toki "tan seme? mi kin li sona ala."
    toki_li_pini
    ;db "The giant egg on"
    ;db "top of Tamaranch"
    ;db "Mountain?  They "
...
Dialog11F:: ;🌞; Kid
    toki "seme a? sina wile sona e tenpo open pi ma telo ni anu seme?"
    toki "tenpo open...li seme?"
    toki "mi lili la, mi sona ala."
    toki_li_pini
    ;db "Dude!  You're   "
    ;db "asking me when  "
    ...
    ; Switch version
    ; Liz Bushouse says that on GBC, the above line gets repeated twice. On Switch, it's repeated once, and the line below, about Marin on the beach, is repeated twice.

Dialog120:: ;🌞; Kid
    toki "tenpo mute la, jan kalama [mu a loje ijo nena]"
    toki "li tawa ma ko pi poka telo li lukin e telo suli."
    toki "mi wile sona e tan..."
    toki "mi lili la, mi sona ala."
    toki_li_pini
    ;db "Marin? She likes"
    ;db "to go stare at  "
...
Dialog121:: ;P4;🌞; Every kid, when Marin is following
...
Dialog122:: ;🌞; Kid
    ...
    ;db "いわないことにするよ。　　　　　"
    ;db "@"
    toki "jan suli o! tomo sewi lape <left>la..."
    toki "insa ona la, ijo pona li lon..."
    toki "taso mi lili la mi o toki ala."
    toki_li_pini

Dialog123:: ;P4;🌞; Kid
    toki "a! jan [mu a loje ijo nena] li"
    toki "lon ala poka sina... tan seme?@"
    toki_li_pini
    ;db "Hunh?!  Marin's "
    ;db "not with you?   "
    ;db "What happened to"
...
Dialog128:: ;🌞; Mamasha, probably
    toki "a! pona tawa sina a! sina pona."
    toki "a! esun la, mi pana e ni."
    toki_li_pini
    ;db "Oh thank you!   "
    ;db "You are indeed a"
    ;db "generous person!"
...
Dialog129:: ;🌞; Narrator
    toki "sina esun e <yoshi>musi e <ribbon>loje a!"
    toki "ken la, sina esun e ijo sin..."
    toki_li_pini
    ;db "You traded your "
...
Dialog12A:: ;🌞; Mamasha
    toki "mi mama pi jan lili tu tu. ona li sama tawa lukin."
    toki "mi lukin e jan lili wan la, tenpo la, mi sona ala e ni:"
    toki "ona li jan lili nanpa seme?"
    toki ""
    toki "jan lili lili mi li wile e akesi musi [jo olin suwi insa]."
    toki "akesi li lon esun musi. mi alasa e ona."
    toki "taso, mi ken ala kama jo e ona."
    toki_li_pini
    ...
    ;db "With four boys  " ; Switch version
    ;db "who look alike, "
    ;db "even I get      "
    ;db "confused        "
    ;db "sometimes...@"
...
Dialog12B:: ;🌞; Mamasha
    toki "mu mama a! jan lili lili mi li wile e akesi musi <yoshi>ni."
    toki "sina wile ala wile pana e ona tawa ona?"
    toki "    wile     ala a-!<ask>"
    ;db "Oh!  Will you   "
    ;db "give that doll  "
    ;db "to my baby?!    "
    ...
    ;db "プレゼントしてくれるのかい？　　" ; is that a present for my baby?
    ;db "　　　　いいよ　　やだよ－ん<ask>" sure! hell no
...
Dialog12D:: ;🌞; Richard
    ...
    ;db "we can talk!    "
    ;db "Good Bye!@"
    ;db "アッ！　コラコラ　だめでしょ－。" a! hey, hey  no good, right~?
    ;db "ワンワンなんか　つれてきちゃ。　" for bow-wow to accompany you. /dismissive
    ;db "ボカァ、そういうヤバンなどうぶつ" i can't get accustomed to
    ;db "すきになれないんだよな－。　　　" savage [animal love]~
...
Dialog12F:: ;🌞; Madam MeowMeow
    ...
    toki "sina pona e soweli mu mu mi la, mi pilin pona suli tawa sina."
    toki "ni la, mi wile pana e pona tawa sina."
    toki "     uta suli----"
    toki "...meli mu mu li pana e pona tawa sina..."
    toki "... mu-  musi a!"
    toki_li_pini
    ;db "Ho ho ho!       "
    ;db "I really appre- "
...
Dialog130:: ;🌞; Madam MeowMeow
    toki "mu musi  mu musi  mu musi"
    toki "soweli mu mu mi li olin e linja selo ona. mu musi"
    toki_li_pini
    ;db "Ho ho ho!  My   "
    ;db "BowWow is so    "
    ;db "proud of his    "
...
Dialog131:: ;P2;🌞; Madam MeowMeow
    toki "ike a! ike a-!"
    ;toki "jan ike li kama jo e soweli mu mu mi a!"
    toki "soweli mu mu mi li weka tan jan... jan..."
    toki "jan soweli ike a-!"
    toki "jan seme li ken pona e soweli mu mu mi?"
    toki_li_pini
    ;db "AIEEEEEEEE!     "
    ;db "It's terrrrible!"
    ;db "My BowWow was   "
    ...
    ;db "help my poor    "
    ;db "BowWow!!@"
    ;db "たいへんざんす　た－いへんざんす" dreadful, dreeeaaadful
    ;db "うちのワンワンが、モッ　モッ　　" my Bow-Wow, m-m-moblins
    ;db "モリブリンに、さらわれたざます！" moblins kidnapped-plight!
    ;db "おお、だれかワンワンをたすけて－" oh, who will help?
    ;db "@"

Dialog132:: ;🌞; Madam MeowMeow
    toki "mu pona-! sina kama jo e soweli mu mu a!"
    toki "pona mute a-"
    toki "tenpo ni la, sina jo e ona la..."
    toki "sina wile ala wile tawa noka lon poka ona lon tenpo lili?"
    toki "...sina wile a! pona tawa sina a!"
    toki_li_pini
    ;db "Oh thank you!   "
    ;db "I'm so happy you"
    ;db "brought my baby "
...
Dialog136:: ;🆖; Narrator, commenting that Christine the goat gave a photo of Princess Peach instead of herself
    db "You got a Broom "
    db "as your reward  "
    db "from Mr. Write! "
    db "But that photo  "
...
Dialog13D:: ;P3;🌞; Richard ;
    toki "a-  sina wawa-"
    toki "sina jo e lipu kasi jelo ale a!"
...
Dialog13F:: ;P3;🌞; Richard ; 1--4 leaves
    toki "a! jan [#####] o! toki a!"
...
Dialog140:: ;🌞; Ulrira, Narrator
    toki "n... ... mu lili..."
    toki "mi sona ala... ..."
    toki "o toki... kepeken ilo... ..."
    toki "... ... tan weka tomo..."
    toki "................"
    toki ""
    toki "ken suli la, ilo toki li pona tawa"
    toki "jan suli [uta linja uta linja ilo linja a]."
    toki_li_pini
    ...
    ;db "in person...@"
    ;db "うむ．．　．．．　．．．　．．．" hmm
    ;db "なんというか．．．　．．．　　　" i don't know
    ;db "デンワ．．．　デンワしてくれ．．" denwa... denwa please
    ;db "．．．　．．．　そとからな．．．" from outside
    ;db "．．．．．．．．．．．．．．．．"
    ;db "どうやら、うるりらじいさんは、　" apparently, old man Ulrira
    ;db "とても、むくちなひとのようです。"
    ;db "@"
...
Dialog141:: ;🌞; Ulrira
    ...
    toki "mi sona e mute pi ma telo ni."
    toki "wile la, o toki tawa mi a!"
    toki "mi tawa."
    toki "mu ilo pini"
    toki_li_pini
    ...
    ;db "coup de fil!    "
    ;db "Salut!  CLIC! @"
    ;db "「チャッ　ジ－コ　ジ－コ　ジ－コ" pick up receiver, dial
    ;db "．．．　プルルル　プルル　ガチャ" ring, he picks up
    ;db "ハロ－！　うるりらじいさんじゃ　" Halo~ Ururira-jiisan ja
    ;db "しまのことなら　わしにおまかせ！" island la, leave it to me!
    ;db "まよったら、わたしにデンワしてく" if you don't mind, call me
    ;db "ださい、どぞよろしく．．ガチャ」"
    ;db "@"
...
Dialog146:: ;🌞; Ulrira
    ...
    toki "toki a!"
    toki "mi jan suli [uta linja uta linja ilo linja a] a!"
    toki "ma tomo la, tomo lipu li lon."
    toki "ken la, ona li pana e sona sin."
    toki "mi tawa."
    toki "mu ilo pini"
    toki_li_pini
...
Dialog14E:: ;🆖; Ulrira
    ...
    ;db "　　うるりら－　　　ガチャッ」　"
    ;db "@"
    ; ma tomo Mebe la, waso kiwen li lon, li tawa tan kon.
    ; anpa ona la, waso wawa li lape.
    ; mi jo e waso la, ona li tawa e mi a lon kon...
    ; sona li pona ala pona tawa sina?
...
Dialog14F:: ;🆖; Ulrira
    ...
    ;db "　うるりら－　　ガチャッ」　　　"
    ;db "@"
    ; akesi kiwen li pini e tawa sina, anu seme?
    ; akesi o moli ala o tawa

Dialog150:: ;🌞; Wind Fish, probably
    toki "    ...ma ko..."
    toki " ...nasin sin li open tawa ma pi kasi kule..."
    toki_li_pini
    ;db "   ...SWAMP...  "
    ;db " A path opens..."
    ;db "in the blooms...@"
...
Dialog152:: ;🌞; Wind Fish, probably
    ...
    toki ""
    toki ""
    toki "mu a! mi Keli [ken.lukin insa]."
...
Dialog15A:: ;🌞; Grandma Yahoo
    ...
    ;db "YAHOO!   I'm    "
    ;db "fine, and you?!@"
    ; I'm fine! I hope you're doing well too-! //GTranslate
    ;db "イヤッホ－！　あたしゃげんきだよ"
    ;db "あんたもげんきでやっとるか－！@"
...
; waso Keli:
; so I should probably not call him Kiki, and just call him jan mu mu.
; this also makes the soweli mu mu rivalry more plausible.
; todo: that ^

Dialog160:: ;P3;🌞; Kiki
    toki "seme a-   soweli mu mu a!"
    toki "o utala a!  mu pi jan mu mu-"
    toki_li_pini
    ;db "Kiiiki!  What?! "
    ;db "All right, mutt!"
    ;db "Let's battle!!@"
...
Dialog161:: ;P3;🌞; Kiki
    toki "mu jan-   mu jan-"
    toki "mu pi jan mu mu"
    toki "mu pi wile moku"
    toki "mu pi jan mu mu"
    toki_li_pini
    ;db "Chi-kiita! Chi- "
    ;db "kiita!  Kiki the"
...
Dialog163:: ;P3;🌞; Kiki
    toki "pali jan a  pini a  tawa  mu jan-"
    toki "jan mu mu"
    toki_li_pini
    ;db "Monkey business!"
    ;db "Done!  Bye bye! "
...
Dialog164:: ;P3;🌞; Narrator
    toki "jan...anu seme...li weka e palisa."
    toki "sina jo e ona a!"
    toki_li_pini
    ;db "You found a     "
    ;db "stick a monkey  "
    ;db "left behind...  "
...
Dialog165:: ;P3;🌞; Kiki, Narrator, Link
    toki "    <bananas>a    <bananas>a    "
    toki "    mu jan-    mu jan-"
    toki "sina wile ala wile pana e ona tawa jan mu mu?"
...
Dialog170:: ;P4;🌞; Papahl
    toki "a a a! mi toki lon: mi sona ala e ni:"
    toki "mi lon seme! a a a!"
    toki "mi wile wawa e moku la  mi ken ala kepeken noka..."
    toki "sina jo ala jo e moku? sina wile ala wile pana?"
    toki "    a a wile!  ala a!<ask>"
    toki_li_pini
    ;db "Yep, Papahl got "
    ;db "lost, just like "
    ;db "he said!  Now, I"
...
Dialog171:: ;P4;🌞; Papahl, if you say nope
    toki "pakala... a a!"
    toki_li_pini
    ;db "You're one cold "
    ;db "hombre...@"
...
Dialog172:: ;P4;🌞; Papahl
    toki "wawa-  <pineapple>suwi a-"
    toki "mi o moku pona a!"
    toki_li_pini
...
Dialog173:: ;P4;🌞; Papahl
    toki "a! ni li lili, taso..."
    toki "<flower2>ni li loje li suwi lukin."
    toki "o jo! o jo a!"
    toki_li_pini
    ;db "AH!  This isn't "
    ;db "meant to be a   "
...
Dialog174:: ;P4;🌞; Narrator
    toki "sina esun e <pineapple>e <flower2>a!"
    toki_li_pini
...
Dialog175:: ;P4;🌞; Papahl
    toki "suwi wawa a! suwi wawa a!"
    toki "mi kama wawa tan moku a!"
    toki_li_pini
    ;db "Delicious!  Yum!"
    ;db "I'm filled with "
    ;db "energy, now!@"
...
Dialog176:: ;P4;🌞; Papahl, later
    toki "sina pona tan pana kili."
    toki_li_pini
    ;db "I've got to say,"
    ;db "thanks again!@"
    ;db "いやあ、このあいだは　　　　　　"
...
Dialog177:: ;P4;🌞; Papahl, before you have food to give him
    toki "a a a! mi toki lon: mi sona ala e ni:"
    toki "mi lon seme! a a a!"
    toki "mi wile wawa e moku la mi ken ala tawa..."
    toki "sina jo ala jo e moku? sina wile ala wile pana?"
    toki "    mi pana ala. ala a!<ask>"
    toki_li_pini
    ;db "Yep, Papahl got "
    ;db "lost, just like "
    ;db "he said!  Now, I"
...
Dialog178:: ;🌞; Grandma Yahoo
    ...
    ;db "あたしゃ、おそうじくらいしか　　"
    ;db "してあげられないけどねえ．．．@"
    ; Liz Bushouse on the Switch version: "The Japanese is roughly: “Yahoo! Wonder if those Moblins were from Tal Tal Heights? They’re horribly rowdy! I’m worried for BowWow.”"
...
Dialog179:: ;🌞; Spirit of the Mansion
    ...
    ;db "あつめて、ゲ－トをくぐってみよう"
    ;db "@"
    toki "... tomo pi weka taso la  ..."
    toki "   ... kalama uta suli li kama  ..."
    toki "mi kon pi tomo pi kiwen kala. mi utala e ike."
    toki "mi awen tawa ni: jan li weka e monsuta ike tan ma."
    toki "o alasa e kiwen kala pi mute pona a!"
    toki "sina ni la  mi pana e palisa utala pi wawa nanpa wan..."
    toki "o tawa insa palisa a!"
    toki_li_pini
...
Dialog17A:: ;🌞; Narrator
    ...
    ;db "@"
    toki "... ala li kama  ..."
    toki "ona li wile e kiwen kala pi mute seme  ..."
    toki_li_pini
...
Dialog17D:: ;🌞; Map, probably
    toki "      esun pi ilo sitelen"
    toki " o kama jo e sitelen! o awen sona e tenpo pona weka a!"
    toki_li_pini
    ;db "Step right up   "
    ;db "and get your    "
    ;db "souvenir photo!@"
...
Dialog17E:: ;🌞; Witch
    toki "  pona. o pana e ona tawa jan ike."
    toki " sina pini e ko la, o pana sin e kili nasa tawa mi."
    toki "   mi pali e ko nasa sin..."
    toki_li_pini
    ;db "Good job!       "
    ;db "Use it on your  "
    ;db "enemies and see "
...
Dialog180:: ;🌞; CiaoCiao
    ...
    ;db "des accessoires "
    ;db "à la mode!@"
    ;db "わたし、オシャレがだ－いすき！　" I love fashion!
    ;db "ピチピチボデイのキャンキャンよ！" I'm a yip-yip with a tight body!
    ;db "ア－ア．．．なんか、カワイイ　　" ah... kawaii
    ;db "アクセサリ－が、ほしいなあ－。@"  accessories would be nice...
...
Dialog182:: ;🌞; Narrator
    toki "sina esun e <ribbon>loje e <dogfood>pi moku soweli a!"
    toki "nena sina li pilin e kon soweli suwi a!"
    toki_li_pini
...
Dialog183:: ;🌞; CiaoCiao
    toki "pona a! pona tawa sina."
    toki "mi pana e <dogfood>pi moku soweli."
    toki_li_pini
    ;db "Lucky!  Thanks! "
    ;db "Well, here's    "
    ;db "your <dogfood>!@"
...
Dialog184:: ;🌞; CiaoCiao
    toki "a suli! ni li ken ala lon a! sina ike mute a!"
    toki_li_pini
    ;db "Eh?!  I can't   "
    ;db "believe it!  You"
    ;db "are the worst!!@"
