...
Dialog191:: ;P2;🌞; Moblin Chief
    ...
    ;db "but it is I who "
    ;db "will get you!!@"
    ;db "エエイ、ワンワンをねらってきたか" wanwan o wile ka
    ;db "さてはおぬし、ワンワンのあるじ、"
    ;db "マダムニャンニャンの　はなった　"
    ;db "しかくであろう、かえりうちじゃ！"
    ;db "@"

Dialog192:: ;P4;🌞; Marin, after the song sequence in Animal Village
    toki "jan [#####] o! tenpo mute la"
    toki "mi kama tawa ma tomo ni tawa kalama musi."
    toki "ale li olin e kalama musi pi kala kon anu seme? a a a"
    toki "jan [#####] o, kalama seme li pona tawa sina"
    toki_li_pini
    ;db "Oh, #####.  I   "
    ;db "often come to   "
    ;db "this village to "
...
Dialog193:: ;P4;🌞; Marin, after teaching you her song in Animal Village
    toki "kalama ni li suli wawa tawa mi a!"
    toki "lon lawa la o awen e ona... e mi..."
    toki_li_pini
    ;db "Please, don't   "
    ;db "ever forget this"
    ;db "song...or me...@"
...
Dialog196:: ;P1;🌞; Fox
    ...
    ; it can only listen
    ; it can't stop
    ; "take advantage of the ability to use colorful sentences" -jP
...
Dialog198:: ;P4;🌞; Marin follower, probably
...
Dialog199:: ;P4;🌞; Marin follower, if you break a pot in her house
    ;db "Ahhh!  Ahhh, you"
    ;db "are a bad boy,  "
    ;db "#####!@"
    ;db "　　　　　あ－－っ！　　　　　　"
...
Dialog19A:: ;P3;🌞; Crazy Tracy, after you buy
    ...
    ;db "ほ－ら、ハ－ト　まんタンよおん！"
    ;db "@"
    toki "o lukin a! mi pana e pona ni kin..."
    toki "mi loje e pilin sina a!"
    toki_li_pini
...
Dialog1A6:: ;P1;🌞; Signpost
    ...
    ;db "should not stand"
    ;db "on them!@"
    ; "Beware of floors with cracks! Don't get too comfortable on them!" ; Switch version
    ;db "ヒビワレゆかに　ちゅうい！　　　"
    ;db "おもたいひとは　のらないように！"
    ;db "@"

Dialog1A7:: ;P1;🌞; Signpost and ; Map
    toki "      tomo pi ilo toki@"
    toki_li_pini
    ;db "Telephone Booth @"

Dialog1A8:: ;P1;🌞; Signpost
    toki "       o awen!"
    toki "       o kama ala!"
...
Dialog1B1:: ;🌞; Signpost
    toki "<right> ma tomo soweli"
    toki "<down> telo suli [ma ante sijelo ante]"
    toki_li_pini
...
Dialog1B4:: ;🌞; Signpost
    toki "supa sewi [tawa awen tawa awen] li lon poka pi ma ni"
    toki "<right> esun pi ilo sitelen li lon poka sina"
    toki_li_pini
    ;db "You're close to "
    ;db "Tal Tal Heights."
    ;db "The Camera Shop "
...
Dialog1B5:: ;🌞; Signpost
    toki "<right> nena sewi [wawa ale ni suli insa]"
    toki "<left> ma ko [pan o noka kala a]"
    toki_li_pini
...
Dialog1B7:: ;🌞; Owl Statue
    ...
    ;db "  FISCH UND KEIN"
    ;db "VOGEL@"
    ;db "「かぜのさかな」はさかなにあらず" ;the wind fish is not a fish
...
Dialog1BE:: ;P4;🌞; Owl Statue
    toki "   sitelen lape li pini la"
    toki "        ale li kama kon"
    toki "   monsuta li utala e pini"
    toki "        li wile ala weka"
    toki_li_pini
    ;db "SEA BEARS FOAM, "
    ;db "SLEEP BEARS     "
    ;db "DREAMS. BOTH END"
...
Dialog1C2:: ;P4;🌞; Tarin, upon refusal
    ;db "Hmmm, #####, you"
    ;db "are mean!@"
    ;db "う－ん　#####いけずだ－よ。"
    ;db "@"
...
Dialog1C4:: ; Tarin
Dialog1C5:: ;P3;🌞; Tarin! after dungeon 2?
    ;db "I was hungry    "
    ;db "somethin' fierce"
    ;db "so I went and   "
    ;db "got bananas at  "
    ...
    ;db "もらってくると　ええだよ．．．．"
    ;db "@"
    toki "mi wile moku la mi tawa ma ko..."
    toki "kili palisa jelo li lon... moku moku a!"
    toki "jan [#####] o, sina wile e kili la"
    toki "sina kin li ken tawa ma ko <down>a!"
    toki_li_pini
...
Dialog1C6:: ;P1;🌞; Sale
    ...
    ; "In Japanese Sale references the starving artist trope and says he feels his brother would be better off if he had good things to eat." -Elizabeth Bushouse

Dialog1C7:: ;P3;🌞; Sale
    toki "a! sina jo e poki a! poki pi moku soweli a!"
    toki "o pana a! <dogfood>pi moku soweli a! o pana a!"
    toki "akesi li toki nasa a! sina wile seme?"
    toki "    pana     awen<ask>"
    ;db "What's that you "
    ;db "have?!  It's    "
    ;db "canned food! For"
...
Dialog1C8:: ;P3;🌞; Sale
    toki "pona mute tawa sina a! tenpo moku li kama a!"
    toki_li_pini
    ;db "Oh thank you!   "
    ;db "I'll take that!@"
    ;db "おおきに、ありがとうっ！　　　　"
...
Dialog1C9:: ;P3;🌞; Sale
    toki "ike..."
    toki "wile pana la, o toki sin tawa mi!"
    toki_li_pini
    ;db "I don't suppose "
    ;db "it would do any "
    ;db "good to beg?    "
...
Dialog1CA:: ;P3;🌞; Sale
    toki "mu moku  mu moku  mu moku........"
    toki "pona mute a a a!"
    toki "pilin pona la, mi pana e kili jelo."
    toki "lon la, ona li suwi mute a!"
    toki_li_pini
    ;db "  MUNCH MUNCH!! "
    ;db "... ... ... ... "
    ;db "That was great! "
    ...
    ;db "but here's some "
    ;db "bananas! YUM...@"
    ;db "モグ　モグ　モグ．．．．．．．．" ; mogu moku mogu
    ;db "こりゃ、うまいわ！！　　　　　　"
    ;db "ほな、おれいにバナナをあげるな。"
    ;db "いや、ほんま、おいしかったわ！@"

Dialog1CB:: ;P3;🌞; Narrator
    toki "sina pana e <dogfood>pi moku soweli tawa akesi."
    toki "akesi li pana e kili <bananas>tawa sina a!"
    toki "ni li pona lili a!"
    toki_li_pini
...
Dialog1CC:: ;P3;🌞; Sale
    toki "pona tawa sina a! moku ni li pona suli a!"
    toki_li_pini
    ;db "Thank you again!"
    ;db "That was yummy!@"
    ;db "ど－も、ごちそうさんでした！@"
...
Dialog1D2:: ;P4;🌞; Chef Bear, before Marin arrives
;    db "オウ！オウ！　ヤ－ナさばくね　　"
;    db "しってるぜ。このむらの　ミナミに"
;    db "いりぐちが　あるんだがな、　　　"
;    db "へんなヤツが　みちをふさいでんだ"
...
Dialog1D4:: ;P4;🌞; Chef Bear
    toki "mu-  jan suwi [mu a loje ijo nena] o!"
    toki "kama pona a!  ...a! sina kin o kama pona a"
    toki_li_pini
;    db "ハイホ－！！！　マリンちゃん　　"
;    db "いらっしゃあい。　　　　　　　　"
;    db "．．．．．．．．おっと？　イケネ"
...
Dialog1E1:: ;P4;🌞; Marin follower, walrus cutscene
...
Dialog1E2:: ;P4;🌞; Marin follower, walrus cutscene
    toki "a a a! wawa"
    toki "o weka pona"
    toki_li_pini
    ;db "Aha ha ha!  Wow!"
...
Dialog1E3:: ;P4;🌞; Marin follower, walrus cutscene
    toki "a! soweli li wile e mi..."
...
Dialog1E4:: ;P4;🌞; Marin follower, walrus cutscene
...
Dialog1E5:: ;P4;🌞; Marin follower, walrus cutscene
...
Dialog1E6:: ;P4;🌞; Walrus, emerging from the water, if Link plays the Ballad
    toki "mu  mu  mu a!"
...
Dialog1F9:: ;🌞; Signpost, but not Map
    toki "      tomo sin pi"
...
Dialog1FD:: ;🌞; Bucket Mouse
    ...
    toki "o pana kepeken tenpo lili a!"
    toki "mu ilo pini"
    toki "ken la, ona li wile toki tawa tomo ante..."
    toki_li_pini
...
Dialog201:: ;P1;🌞; Book
    ...
    toki "sinpin awen li ken tawa e pipi."
    toki "nasa a!"
    toki "linja seli li utala e sina la," ; suno linja? linja seli? seli linja?
    toki "sinpin awen nanpa tu li ken awen e sina."
    toki_li_pini
...
Dialog202:: ;P1;🌞; Book, Narrator
    ...
    ;db "Read this book? "
    ;db "    YES  NO<ask>"
    ;db "「アイテムのセレクトほうほう」　" ; way of selecting items
    ;db "このほんを　よもうかな？　　　　"
    ;db "　　　　よむ　　　よまない<ask>"
...
Dialog203:: ;P1;🌞; Book
    ...
    toki ""
    toki "sina lon lipu la, o luka e nena Ae nena B!"
    toki "nasin ni la, sina ken kepeken ilo ante."
    toki "o utala kepeken ilo mute a!"
    toki "ilo li pona tawa sina la, o kepeken ona!"
    toki_li_pini
...
Dialog204:: ;P1;🌞; Book, Narrator
    ...
    ;db "Read this book? "
    ;db "    YES  NO<ask>"
    ;db "　　「マップがめんとメモ」　　　" ; map menu and memo
    ;db "このほんを　よもうかな？　　　　"
    ;db "　　　　よむ　　　よまない<ask>"

Dialog205:: ;P1;🌞; Book, Narrator
    toki "sina ken lukin e lipu ma kepeken nena SELECT."
    toki ""
    toki "tenpo open la, lipu ma li pimeja. ma li len."
    toki "sina tawa ma la, sina ken lukin e ona lon lipu."
    ;toki "sina tawa ala ma la, ona li pimeja."
    ;toki ""
    toki "lon lipu la, o luka e nena <dpad>!"
    toki "ni li tawa e poki ma."
    toki "lon poki la, o luka e nena A!"
    toki "sina ni la, lipu li toki e nimi ma."
    toki "waso sona li toki lon ma la, lipu li toki sin."
    toki "...a! pona a!"
    toki_li_pini
    ;db "'You can see an "
    ;db "island map by   "
    ...
    ;db "tu n'auras pas  "
    ;db "à tout noter!@"
    ;db "セレクトボタンをおすと、しまの　" ;select button la,
    ;db "ちずをみることが、できます。　　" ;look at island map, you can.
    ;db "くろくなって　みえないところは、" ;black sections you can't see are areas you haven't visited
    ;db "まだ、いってないところです。　　"
    ;db "カ－ソルをあわせて　Ａ　ボタンを"
    ;db "おせば、ちめいや　フクロウの　　"
    ;db "メッセ－ジなどをよむことができ、"
...
Dialog206:: ;P1;🌞; Book, Narrator
    ...
    ;db "Tu veux le lire?"
    ;db "    Oui  Non<ask>"
    ;db "　「ひでん！　かいてんぎり」　　" ; mystery that is only taught to certain people! rotary slash
    ;db "このほんを　よもうかな？　　　　"
    ;db "　　　　よむ　　　よまない<ask>"
...
Dialog207:: ;P1;🌞; Book
    ...
    toki "jan lili li kama mama la ona li pana sin."
    toki "nasin li ni:"
    toki "sina ken tawa sike e palisa utala sina."
    toki "o awen luka e nena pi palisa utala  o kama jo e wawa"
    toki "wawa li lon la o weka e luka tan nena"
    toki "sina ken ala ken ni?"
    toki_li_pini
...
Dialog209:: ;P1;🌞; Book
    ...
    toki "lupa li ken ala tawa e sina..."
    toki_li_pini
...
Dialog20A:: ;P1;🌞; Book, Narrator
    ...
    ;db "Read this book? "
    ;db "    YES  NO<ask>"
    ;db "　　「バクダンは　かつげる」　　" bomb wa carry
    ;db "このほんを　よもうかな？　　　　"
    ;db "　　　　よむ　　　よまない<ask>"

Dialog20B:: ;P1;🌞; Book
    toki "o luka e nena! sina pana e sike pakala."
    toki "o luka sin e nena! sina jo sin e sike."
    toki "o luka sin e nena! sina pana sin e sike a!"
    toki "tenpo pini la, sina sona ala sona e ni?"
    toki_li_pini
    ;db "'After you put a"
    ;db "Bomb down, you  "
    ;db "can pick it up  "
...
Dialog20D:: ;P1;🌞; Book, Narrator
    toki "      lipu pi sona len"
    ;toki "       toki len suli"
    ;toki "  pi ma telo [kon o kon o lape insa nena]  "
    toki "sina... sina ken lukin e lipu ni..."
    toki "    o lukin    mi wile ala a!<ask>"
    ;db " 'Dark Secrets  "
    ;db "  And Mysteries "
    ;db "   Of Koholint' "
    ;db "Do you really   "
    ;db "want to read it?"
    ;db "    YES  NO<ask>"
    ;db "　　　「ヒミツのほん？！」　　　"　secret book?!
    ;db "このほんよみたい．．．？　　　　"
    ;db "　　　　うん！　　べ、べつに<ask>"

Dialog20E:: ;P1;🌞; Book, Narrator
    ; todo: jT suggests wekaing "o pilin pona"
    toki "a  sina lukin a"
    toki "................"
    toki "................"
    toki "sitelen li lili. ni la sina ken ala lukin e ona."
    toki "sina kama jo e ilo lukin la sina ken lukin."
    toki "    o awen pilin pona a!"
    toki_li_pini
    ;db "Gasp! Wha-What's"
    ;db "this! ... ...   "
    ;db "You can't read  "
...
Dialog21E:: ;P4;🌞; Marin follower
    ...
    ;
    ;   I told you so...
    ;   Huh? What?! No, I can't hear anything.
    ;   Really!
    ;
...
Dialog220:: ;P2;🌞; Kid
    ...
    toki "kulupu suli pi soweli pi ma kasi nasa a! ni la..."
    toki "ni li lon a! ona li tawa tomo wan..."
    toki "ona li tawa tomo pi soweli mu mu a! ona li..."
    toki "ona li seme... ni li lon lon lon a!"
    toki "soweli ike li  n  ni la  n......"
    toki ""
    toki ""
    toki "ken la, sina ken kama sona kepeken nasin sina a!"
    toki "ken la, ni li wile e tenpo lili a!"
    toki_li_pini
    ;db "Hey buddy!  It's"
    ;db "serious!  Yeah, "
    ;db "really serious!!"
...
Dialog22B:: ;P3;🌞; Photo Album, Narrator
    toki "   jan suli [#####]"
    toki "sina wile ala wile lukin e lipu ni?"
    toki "    wile     ala<ask>"
    ;db "'The Travels of "
...
Dialog240:: ;P4;🌞; Ulrira
    ...
    toki "toki a!"
    toki "mi jan suli [uta linja uta linja ilo linja a] a!"
    toki "mama mama meli li toki e ni: nena [tawa awen tawa awen]"
    toki "la,  telo tawa anpa la,  monsi telo la,  ijo li len."
    toki "mi pona e sina anu seme..."
    toki "weka [uta linja uta linja ilo linja a]-"
    toki "mu ilo pini@"
    toki_li_pini
    ;db "'BRRING! BRRING!"
