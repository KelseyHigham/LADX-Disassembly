...
Dialog1A9:: ;P4;☀️; Signpost
    ;db "<down> GO THIS WAY@"
    ;db "　<down>　の　ほうこうへすすめ@"
    toki "      o tawa <down>@"

Dialog1AA:: ;P4;☀️; Signpost
    ;db "<up> GO THIS WAY@"
    ;db "　<up>　の　ほうこうへすすめ@"
    toki "      o tawa <up>@"

Dialog1AB:: ;P4;☀️; Signpost
    ;db "<right> GO THIS WAY@"
    ;db "　<right>　の　ほうこうへすすめ@"
    toki "      o tawa <right>@"

Dialog1AC:: ;P4;☀️; Signpost
    ;db "<left> GO THIS WAY@"
    ;db "　<left>　の　ほうこうへすすめ@"
    toki "      o tawa <left>@"

Dialog1AD:: ;P4;☀️; Signpost
    ;db " TRY AGAIN FROM "
    ;db "   THE START@"
    ;db "　　もういちど　さいしょから　　"
    ;db "　　　やりなおし！@"
...
Dialog1B9:: ;☀️; Owl Statue, reward for Richard quest
    ;db "IN SOIL SLEEPS  "
    ;db "SECRETS, BENEATH"
    ;db "YOUR SOLES...@"
    ;db "　　　あしもとに　ヒミツあり@"
...
Dialog1C2:: ;☀️; Tarin, upon refusal
    ;db "Hmmm, #####, you"
    ;db "are mean!@"
    ;db "う－ん　#####いけずだ－よ。"
    ;db "@"
...
Dialog1C4:: ; Tarin
Dialog1C5:: ;☀️; Tarin! after dungeon 2?
    ;db "I was hungry    "
    ;db "somethin' fierce"
    ;db "so I went and   "
    ;db "got bananas at  "
...
Dialog22E:: ;P3;☀️; Photographer, Richard photo part 1
    ;db "Hi, #####. You  "
    ;db "know I love to  "
    ;db "take pictures.  "
    ;db "Wouldn't this   "
...
Dialog23C:: ;P3;☀️; Richard, Richard photo part 2
    ;db "Nothing yet?! I "
    ;db "grow tired of   "
    ;db "waiting. I want "
    ;db "those Golden    "
...
Dialog249:: ;P3;☀️; Richard, Richard photo part 3
    ;db "Go ahead and    "
    ;db "take a picture  "
    ;db "of me. Any angle"
    ;db "you like!@"
